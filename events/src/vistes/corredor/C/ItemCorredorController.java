...
public class ItemCorredorController {
	@FXML
	private Label club;
	@FXML
	private Label dni;
	...
	private void load() {
		...
		this.localitat.setText(corredor.getLocalitat());
		if (corredor.getClub() == null)
			this.club.setText("independent");
		else {

			this.club.setText(corredor.getClub().getNom());
		}
		this.data.setText(corredor.getDatanaixement().toString());
